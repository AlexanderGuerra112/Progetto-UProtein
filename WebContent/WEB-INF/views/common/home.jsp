...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="nav-icons">
            <a href="${pageContext.request.contextPath}/login?azione=mostra" style="color:white; margin-right:20px; text-decoration:none;">👤 Profilo</a>
    ...
    <footer style="background: #1A1A1A; color: white; padding: 40px 5%; margin-top: 50px;">
        <div style="display: flex; justify-content: space-between;">
            <div>
                <h4>UProtein</h4>
                <p style="font-size: 12px; color: #6B6B6B;">© 2026 UProtein. All rights reserved.</p>
            </div>
